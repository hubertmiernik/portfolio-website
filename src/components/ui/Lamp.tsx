...
export const LampContainer = ({ className }: { className?: string }) => {
  return (
    <div
      className={cn(
        "flex min-h-screen flex-col items-center justify-center overflow-hidden bg-white w-full rounded-md z-0 -mt-[18rem]",
        className,
      )}
    >
      <div className="flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        <motion.div
